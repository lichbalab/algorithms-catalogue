...
class AVLTreeAndArrayEncDecTest {
    ...
    void testAlgorithm() throws IOException {
        ...
        for (File file : files) {
            try (FileInputStream is = new FileInputStream(file)) {
                ...
                AVLTreeAndArrayEncDec.main(new Object[]{ps});
    ...
    void testAlgorithmDecBench30000() throws IOException {
        ...
        try (FileInputStream is = new FileInputStream(file)) {
            ...
            AVLTreeAndArrayEncDec.main(new String[]{});
    ...
    void generateTestData() throws IOException {
        ...
        int[] encrypted = AVLTreeAndArrayEncDec.encrypt(list, 300000, 300000);
        for (int i = 0; i < 300000; i++) {
